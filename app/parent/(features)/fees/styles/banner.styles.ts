export const bannerStyles = {
  ...
  title: "text-[--color-custom-white] font-medium text-xl sm:text-lg md:text-xl",
  description: "text-[--color-custom-white]/90 text-sm leading-relaxed sm:text-xs md:text-sm",
